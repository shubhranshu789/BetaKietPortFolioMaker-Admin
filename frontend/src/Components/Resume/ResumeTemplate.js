...
function ResumeTemplate() {
  ...
  const handleSubmit = async () => {
    ...
    if (!year || !Degree || !institute) {
      ...
      notifyA('Please add all the Academic details')
      return;
    }
  ...
  const handleSubmitAchievements = async () => {
    ...
    if (!Achievements) {
      ...
      notifyA('Please add your Achievements')
  ...
  const handleSubmitExtra = async () => {
    ...
    if (!extra) {
      ...
      notifyA('Please add the extra information')
  ...
  const handleSubmitTechnical = async () => {
    ...
    if (!Technical) {
      ...
      notifyA('Please add your Technical skills')
    ...
    <div>
      ...
      <div className="resumeMainBody">
        ...
        <div className="extraSection section">
          ...
          <input type="text" placeholder="Enter your internship" value={extra} onChange={(e) => setextra(e.target.value)} />
